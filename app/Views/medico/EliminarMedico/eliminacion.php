    ...
    $('.pagination1 a').on('click', function (e) {
        ...
        if (clickedPage === '<<') {
                ...
                if (medicos.length > 0) {
                    ...
                    medicos.forEach(medico => {
                        tabla += `<tr class="style_table">
                                    ...
                                    <td>${medico.email || '-'}</td>
                                    <td><a href="#" class="img-center eliminar" data-id="${medico.id}" data-matricula="${medico.matricula}" data-nombre="${medico.nombre}" data-apellido="${medico.apellido}" data-toggle="modal" data-target="#confirmModal"><img src="<?= base_url('img/delete.png'); ?>" alt="logo" class="img-action""></a></td>
                                </tr>`;
                    });
            ...
            let medicoId;
                ...
                $('#muestra-medicos').on('click', '.eliminar', function() {
                    medicoId = $(this).data('id');
                    const matricula = $(this).data('matricula');
                    const nombre = $(this).data('nombre');
                    const apellido = $(this).data('apellido');

                    $('#confirmModal .modal-body').html(`¿Estás seguro de que deseas eliminar al medico? :
