  ...
  <div class="container_principal">
    ...
    <div class="container_inicio">
      ...
      <section class="main-container__form-section">
        <form class="form" id="editar-medico-form" >
        ...
        $(document).ready(function() {
            ...
            $.ajax({
                ...
                success: function(medico) {
                    ...
                    $('#provincia').val(medico.provincia);
                    $('#localidad').val(medico.localidad);
                    $('#cp').val(medico.cp);
                    $('#calle').val(medico.calle);
                    $('#altura').val(medico.altura);
                    $('#prefijo').val(medico.prefijo);
                    $('#celular').val(medico.celular);
                ...
                error: function(jqXHR, textStatus, errorThrown) {
                    console.error('Error al obtener el medico:', textStatus, errorThrown);
                }
            });

            // Manejador del evento submit del formulario
            $('#editar-medico-form').on('submit', function(e) {
                e.preventDefault();
                ...
                $.ajax({
                        ...
                        success: function(response) {
                            ...
                            window.location.href = '<?= base_url('index.php/pagprincipal/medico/modificar') ?>';
                        },
                        error: function(jqXHR) {
                            ...
                            if (jqXHR.status === 422) {
                                ...
                                if (errors.matricula) {
                                    $('.form_error1').text(errors.matricula[0]).addClass('show1');
                                }
                            } else {
