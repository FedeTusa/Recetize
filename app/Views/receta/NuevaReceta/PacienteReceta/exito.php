  ...
  <div class="titulo-exito">
    ...
    <div class="options">
      <div class="row">
        ...
        <div class="col-md-4 option boton-exito" onclick="window.location.href='http://recetize.test/index.php/pagprincipal/recetapaciente/nuevo'">
          Cargar Nuevo Paciente</div>
        <div class="col-md-4 option2 boton-exito" onclick="window.location.href='http://recetize.test/index.php/pagprincipal/receta/nuevo'">
          Atrás</div>
